'''
    ...
    설명 : 함수에 일을 시키고 그 값을 받아오도록 하자

    원의 넓이 구하기.
    반지름이 3인 원의 넓이를 구한다.
    반지름 값을 전달받아(매개변수) 원의 넓이를 구하고, 넓이를 돌려주는(return) 함수를 작성.
...
def area(radius) :  # 전달 받은 반지름을 매개변수에 저장
...
print(f"반지름이 3인 원의 넓이는 {result} 입니다.") # result에 저장된 결과 출력
