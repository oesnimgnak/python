...
print('num1.union(num2)', num1.union(num2)) # 합집합 연산자

print('num1 & num2', num1&num2) # 교집합 연산자
print('num1.intersection(num2)', num1.intersection(num2)) # 교집합 연산자

print('num1 - num2', num1-num2) # 차집합 연산자
print('num1.difference(num2)', num1.difference(num2)) # 차집합 연산자

print('num1 ^ num2', num1^num2) # 대칭 차집합 연산자
print('num1.symmetric_difference(num2)', num1.symmetric_difference(num2)) # 대칭 차집합 연산자